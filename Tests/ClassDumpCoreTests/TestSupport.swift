...
let cpuSubtypeLib64: cpu_subtype_t = cpu_subtype_t(bitPattern: 0x8000_0000)
...
func mockFatData(
    arches: [(cputype: cpu_type_t, cpusubtype: cpu_subtype_t, offset: UInt32, size: UInt32, align: UInt32)]
) -> Data {
    var data = Data()
