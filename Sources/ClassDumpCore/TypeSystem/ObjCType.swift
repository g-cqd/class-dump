...
public indirect enum ObjCType: Sendable, Equatable {
  ...
  private func typeString(includeVariableNames: Bool, showObjectTypes: Bool) -> String {
    ...
    case .array(let count, let t):
      return "[\(count)\(t.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes))]"
    ...
    case .const(let t):
      return "r\(t?.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes) ?? "")"
    case .in(let t):
      return "n\(t?.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes) ?? "")"
    case .inout(let t):
      return "N\(t?.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes) ?? "")"
    case .out(let t):
      return "o\(t?.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes) ?? "")"
    case .bycopy(let t):
      return "O\(t?.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes) ?? "")"
    case .byref(let t):
      return "R\(t?.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes) ?? "")"
    case .oneway(let t):
      return "V\(t?.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes) ?? "")"
    case .complex(let t):
      return "j\(t?.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes) ?? "")"
    case .atomic(let t):
      return "A\(t?.typeString(includeVariableNames: includeVariableNames, showObjectTypes: showObjectTypes) ?? "")"
    }
  }
}
