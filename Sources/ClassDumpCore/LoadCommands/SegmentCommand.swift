...
public enum SegmentEncryptionType: Sendable, Equatable {
  ...
  public static let magicAES: UInt32 = 0xc2286295
  public static let magicBlowfish: UInt32 = 0x2e69cf40
...
extension SegmentCommand: CustomStringConvertible {
  public var description: String {
    ...
    return String(format: "SegmentCommand(%@, vmaddr: 0x%0*llx, vmsize: 0x%llx, fileoff: %llu, flags: %@, nsects: %u)",
                  name, ptrWidth, vmaddr, vmsize, fileoff, flags.description, nsects)
  }
}
