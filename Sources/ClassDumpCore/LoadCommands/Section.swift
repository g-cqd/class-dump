...
public struct SectionType: OptionSet, Sendable {
  ...
  public static let threadLocalInitFunctionPointers = SectionType(rawValue: UInt32(S_THREAD_LOCAL_INIT_FUNCTION_POINTERS))
...
extension Section: CustomStringConvertible {
  public var description: String {
    ...
    return String(format: "Section(%@,%@, addr: 0x%0*llx, size: 0x%llx)",
