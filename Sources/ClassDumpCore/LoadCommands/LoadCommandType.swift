...
public enum LoadCommandType: UInt32, Sendable, CaseIterable {
  ...
  case loadUpwardDylib = 0x80000023     // LC_LOAD_UPWARD_DYLIB
  ...
  case dyldExportsTrie = 0x80000033     // LC_DYLD_EXPORTS_TRIE
  case dyldChainedFixups = 0x80000034   // LC_DYLD_CHAINED_FIXUPS
  case filesetEntry = 0x80000035        // LC_FILESET_ENTRY
